...
class ProductItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_item" do
    assert_difference('ProductItem.count') do
      post product_items_url, params: { product_item: { number: @product_item.number, product_id: @product_item.product_id, user_id: @product_item.user_id } }
    end
  ...
  test "should update product_item" do
    patch product_item_url(@product_item), params: { product_item: { number: @product_item.number, product_id: @product_item.product_id, user_id: @product_item.user_id } }
